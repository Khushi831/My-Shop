...
<form action="" method="post" >
    ...
    <table align="center" width="600">
        ...
        <tr>
            ...
            <td><input type="text" name="c_address" size="60" <img src="customer_photos"/ <?php echo $image; ?>> /></td>
        </tr>
...
<?php
 ...
 if(isset($_POST['update_account'])){
    ...
    $update_c="UPDATE customers SET customer_name='$c_name', customer_email='$c_email' , customer_pass='$c_pass',customer_city='$c_city',customer_contact='$c_contact',
    customer_address='$c_address', customer_image='c_image' WHERE customer_id='$update_id'";

    $run_c=mysqli_query($update_c);
